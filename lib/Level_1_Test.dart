...
import 'package:sebawayh/Answer_Correct.dart';
import 'package:sebawayh/Answer_Wrong.dart';
import 'package:sebawayh/Level_1_Test2.dart';
import 'package:sebawayh/main.dart';

class Level1Test extends StatelessWidget {
  @override
          ...
          children: <Widget>[
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => WrongL1()));
                    },
                    child: Text(
                      'ل',
                      style: TextStyle(
            ...
            Container(
              ...
              child: Material(
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => CorrectL1()));
                    },
                    child: Text(
                      'ك',
                      style: TextStyle(
            ...
            Container(
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(context,
                      CupertinoPageRoute(builder: (context) => Level1Test2()));
                },
                child: Text(
                  'Next',
                  style: TextStyle(
